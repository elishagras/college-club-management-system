...
$get_count = 'SELECT member_count FROM club where club_name="roboticsclub"';
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-8">
            <div class="header-text-holder">
              <span class="head-bg">WELCOME TO THE ROBOTICS CLUB!</span>
      ...
      <div class="container">
        ...
        <div class="musicbg">
          ...
          <div class="col-lg-8 col-md-3 space">
            ...
            <div>
              <p class="desc">
                Students design and build their robots from the ground up and must program the robots for the autonomous part of the competition as well as user controlled portion. Students learn the fundamentals of engineering design and computer programming. Students work in groups based on age and experience. 
