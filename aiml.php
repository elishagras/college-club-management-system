...
<?php
include('server.php');
$get_users = 'SELECT * FROM registered, users where club_name="ai/mlclub" AND registered.Roll_No=users.Roll_No';
...
$get_count = 'SELECT member_count FROM club where club_name="ai/mlclub"';
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-8">
            <div class="header-text-holder">
              <span class="white_bg">WELCOME TO THE AI/ML CLUB!</span>
      ...
      <div class="container">
        ...
        <div class="musicbg">
          ...
          <div class="col-lg-8 col-md-3 space">
            ...
            <div>
              <p class="desc">
                The objective of the club is to equip the students with the ability and skills to analyze, design and develop computer systems and their applications. 
