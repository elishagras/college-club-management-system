...
include 'server.php';
  ...
  if (count($errors) == 0) {
  	...
  	$query = "SELECT Roll_No, password FROM admin WHERE Roll_No='$Roll_No' AND password='$password'";
            ...
            <div class="card-body">
              <div class="card-title">
                ...
                <?php include('errors.php'); ?>
                  ...
                  <p class="log">Don't have an account? <a href='adminsignup.php'>Sign Up Here</a>
                  <div class="mb-3">
